            ...
            <div class="col-auto">
                <form action="php/login_usuario.php" method="POST">
                    ...
                    <div class="form-group form-check m-2">
                        ...
                        <label class="form-check-label" for="exampleCheck1">guardar credenciales</label>
                    </div>
                    <button id="iniciar-sesion" type="submit" class="btn btn-primary centrar mx-auto m-4">Iniciar sesión</button>
                    
                    <small id="emailHelp" class="form-text text-muted mx-auto">No estas registrado aún, 
                        <a href="Registro.php">registrate aquí.</a></small> 
                </form>
            </div>
        </div>
    </div>
