...
<head>
  ...
  <title>W.E.S-In</title>
</head>

<body>
  <div class="d-flex" id="content-wrapper">

  <div id="sidebar-container" class="bg-blue">
            <div class="logo">
              <img src="assets/img/911.jpg" class="image-fluid rounded-circle" width="50%">
                <!-- <h4 class="text-light font-weight-bold mb-0 " >Sevilla 911</h4> -->
            </div>
            <div class="menu">
                ...
                <a href="#" class="d-block text-light p-3 border-0"> <i class="icon ion-md-settings lead mr-2"></i>
                    Configuración</a>
                <a href="#" class="d-block text-light p-3 border-0"> <i class="icon ion-md-help lead mr-2"></i>
                    Ayuda</a>    
            </div>
        </div>
    <!-- Fin sidebar -->
    ...
    <div class="w-100">
            ...
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
              <li class="nav-item dropdown">
                <a class="nav-link text-light dropdown-toggle" href="#" id="navbarDropdown" role="button"
                  ...
                  <img src="assets/img/user-2.png" class="img-fluid rounded-circle avatar mr-2"
      ...
      <!-- Page Content -->
      <div id="content" class="bg-dark w-100">

        <section class="bg-dark py-3">
          <div class="container">
            <div class="row">
              <div class="col-lg-9 col-md-8">
                <h1 class="text-light font-weight-bold mb-0">Bienvenido Adrian</h1>
